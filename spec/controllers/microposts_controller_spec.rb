...
#         post :create, {:micropost => {}}, valid_session
#         assigns(:micropost).should be_a_new(Micropost)
#       end
...
#         Micropost.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
#         put :update, {:id => micropost.to_param, :micropost => {'these' => 'params'}}, valid_session
#       end
...
#         # Trigger the behavior that occurs when invalid params are submitted
#         Micropost.any_instance.stub(:save).and_return(false)
#         put :update, {:id => micropost.to_param, :micropost => {}}, valid_session
#         assigns(:micropost).should eq(micropost)
#       end
